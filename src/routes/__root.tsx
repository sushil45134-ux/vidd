...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "vid — stream what you love" },
      { property: "og:description", content: "vid is a cinematic streaming home for your uploads, playlists, and picks." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Kanit:wght@700;800&family=Unbounded:wght@800;900&display=swap",
      },
    ],
  }),
